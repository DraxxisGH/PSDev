...
recipes.addShaped(<exnihilocreatio:item_mesh:4>, [[<botania:spellcloth>, <thaumcraft:crystal_essence>, <botania:spellcloth>],[<thaumcraft:crystal_essence>, <exnihilocreatio:item_mesh:3>, <thaumcraft:crystal_essence>], [<botania:spellcloth>, <thaumcraft:crystal_essence>, <botania:spellcloth>]]);
...
recipes.addShaped(<exnihilocreatio:item_mesh:1>, [[<botania:manaresource:16>, <botania:manaresource:16>, <botania:manaresource:16>],[<botania:manaresource:16>, <botania:manaresource:16>, <botania:manaresource:16>], [<botania:manaresource:16>, <botania:manaresource:16>, <botania:manaresource:16>]]);
//Renaming Things
